  ...
  <div class="container" id="apartamenty">
    ...
    <div class="row align-items-center my-5">
      ...
      <div class="col-lg-5">
        ...
        <a class="btn btn-primary" href="apartament_1.html">Więcej zdjęć</a>
      </div>
      <!-- /.col-md-4 -->
    </div>
      ...
      <div class="row h-100 align-items-center">
        <div class="col-12 text-center">
          ...
          <form action="process.php" method="post">
              ...
              <br/>
              <textarea name="wiadomosc" rows="4" cols="63" id="message" placeholder="Treść wiadomości" required></textarea>
              <br/>
